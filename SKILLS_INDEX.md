...
- `sdlc-architecture-domain-model`: derive domain entities, relationships, invariants, and lifecycle states from requirements.
- `sdlc-architecture-adr`: write architecture decision records.
