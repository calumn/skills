...
- Consider committing/diffing the generated schema in CI so an unannounced breaking change fails loudly instead of surfacing later as a confusing integration bug.
